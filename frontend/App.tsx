...
const NAV_ITEMS: ResponsiveLayoutItem[] = [
  ...
  { key: 'dossier', label: 'Foto\'s', desktopLabel: 'Projectfoto\'s', icon: FolderOpen },
  { key: 'kaart', label: 'Kaart', desktopLabel: 'GPS Kaart', icon: Map },
  { key: 'oplevering', label: 'Borgingslijst', desktopLabel: 'Borgingslijst', icon: ClipboardCheck },
  { key: 'review', label: 'Beoordeling', desktopLabel: 'Beoordelingen', icon: ShieldCheck },
